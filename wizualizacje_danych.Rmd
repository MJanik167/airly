...
pm25_names <- c(
  ...
  "pm25_12_8",  "pm25_12_16",  "pm25_12_21"
)
...
plot(krakowUTM, main = "Czujniki wykluczone z analizy")
plot(czujniki_spdf, add = TRUE, pch = 16, col = "grey")
points(czujniki_spdf[c(2,21), ], pch = 8, col = "red", cex = 1.5)
```
...
miss_vec <- miss[[paste0("miss_", colname)]]
miss_vec
czujniki_spdf[!miss_vec,]$pm25_09_8
# a<-as.data.frame( czujniki_spdf[!miss_vec,3:12] )
# a<-a[1:10]
# 
# is.na(any(a))
