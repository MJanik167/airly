...
ggplot() +
  geom_sf(data = dzielnice, fill = "lightblue", color = "black") +
  geom_sf(data = paleniska, fill = NA, color = "red", linewidth = 1) +
  theme_minimal()
...
#paleniskaUTM<-st_transform(paleniskaWGS84,CRS("+proj=utm +zone=34 +datum=WGS84"))
